...
export const REWARD_DESCRIPTIONS = {
  REPORT: { pts_display: '1', label_fr: "Signalement d'un conteneur ", label_ar: 'الإبلاغ عن حاوية ممتلئة' },
  ...
  COLLECTION_COMPLETED: { pts_display: '4', label_fr: 'Collecte réalisée', label_ar: 'إتمام عملية الجمع' },
};
